...
for country in all_countries:
    ...
    sentence = f'country name is {country_name}. {country_name} currenceis is {country_currencies}. {capital} is capital of {country_name}.' \
               f'This is {region} region. {languages} is mother language of {country_name}. This ia {continents} of {region}.' \
               f'The {country_name} population of {population}.'
    print(sentence)