...
for comments in post_comments:
    user_id = comments.get('id')
    user_name = comments.get('name')
    user_email = comments.get('email')
    user_body = comments.get('body')
    print(user_id, user_name, user_email, user_body, sep='.')