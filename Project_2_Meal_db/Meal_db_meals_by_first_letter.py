...
"strIngredient14": "",
"strIngredient15": "",
"strIngredient16": True,
"strIngredient17": True,
"strIngredient18": True,
"strIngredient19": True,
"strIngredient20": True,
...
meal = all_meals.get('meals')

for i in meal:
    strMeal_name = i.get('strMeal')
    category = i.get('strCategory')
    area = i.get('strArea')
    youtube_channel = i.get('strYoutube')

    print(strMeal_name, category, area, youtube_channel, sep=', ')
