...
for categori in categories:
    id = categori.get('idCategory')
    strcategory = categori.get('strCategory')
    categorythumb = categori.get('strCategoryThumb')
    description = categori.get('strCategoryDescription')

    print(id, strcategory, categorythumb, description, sep='.')
